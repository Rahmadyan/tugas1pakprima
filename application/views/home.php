...
<html lang="">
	...
	<body>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jumbotron">
				<div class="container">
					<h1 class="text-center">Hello, <?php echo $nama ?></h1>
					<p class="text-center">Tonton Video Saya di Sini..
					</p>
					<p>
					<div class="text-center"><a class="btn btn-lg btn-primary" href="<?php echo site_url()?>/home/video" role="button">More</a></div>
						
					</p>
					<p class="text-center">We are a gaming channel dedicated to showcase the best gaming videos! Any game. Any platform.
contains about funny videos in the game </p>
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
...
<!--<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center">
	<img width="200" height="140" src="<?php echo base_url()?>images/1.png" alt="..." class="img-rounded">	
